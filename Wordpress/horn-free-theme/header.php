...
<a class="brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>"><img class="brand-logo" src="<?php echo esc_url( 'https://www.hornfreeindia.org/wp-content/uploads/2026/09/horn-logo-optimized.png' ); ?>" alt="" width="58" height="58"></a>
