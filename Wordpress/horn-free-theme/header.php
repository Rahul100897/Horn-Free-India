...
<a class="brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>"><img class="brand-mark" src="<?php echo esc_url( 'https://www.hornfreeindia.org/wp-content/uploads/2026/09/icon.png' ); ?>" alt="" width="28" height="28"><span class="brand-name">Horn Free <span>India</span></span></a>
