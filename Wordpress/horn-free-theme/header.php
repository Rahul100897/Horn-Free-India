...
<a class="brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>"><span class="brand-mark" aria-hidden="true">☮</span><span class="brand-name">Horn Free <span>India</span></span></a>
